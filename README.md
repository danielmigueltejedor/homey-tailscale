...
**Supported hardware:** Homey Pro (Early 2023+), Homey Pro mini, Homey Pro (2026), Homey Self-Hosted Server (aarch64).  
**Not supported:** Homey Pro (2019) — Athom’s Python Apps SDK does not run on that model.
...
| Homey Pro 2019 | Not supported (Athom Python runtime is only on 2023+ / mini / self-hosted). |
...
- Homey Pro (2019) no está soportado: el runtime Python de Athom no corre en ese modelo.
...
- Binaries: `bin/aarch64/` Tailscale 1.96.2
